...
eachTeamAproxHalfTheRoundsHomeHalfAway :- numTeams(N), team(T), N1 is N/2, N2 is N1 - 1, findall(home(T,R), round(R), Lits), atLeast(N2, Lits), atMost(N1, Lits), fail.
eachTeamAproxHalfTheRoundsHomeHalfAway.

eachRoundTwoHomeTwoAwayOf1234 :- round(R), findall(home(T,R), teamCity(T), Lits), exactly(2, Lits), fail.
eachRoundTwoHomeTwoAwayOf1234.
