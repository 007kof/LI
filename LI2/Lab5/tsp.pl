...
tsp( Cities, AccumulatedKm, [ CurrentCity | RouteSoFar ] ) :-
    ...
    selectTheClosestCity(CurrentCity, Cities, RemainingCities, City),
...
selectTheClosestCity(CC,CS,RCS,C) :- nearestCity(CC,CS,C), removeCity(C,CS,RCS).

nearestCity(CC,[CS],CS).
nearestCity(CC,CS,C).
